...
def graphX(pc_feats, out_channel, num_instance, rank, bias, activation):
    ...
    main = graphXConvAtten(main,out_channel,num_instance=num_instance,rank=rank,bias=bias,activation=activation)

    #res
    res = graphXConvBase(pc_feats,out_channel,num_instance=num_instance,rank=rank,bias=bias,activation=activation)
