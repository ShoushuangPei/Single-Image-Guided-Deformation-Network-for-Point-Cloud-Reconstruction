...
class DataFetcher(threading.Thread):
    def __init__(self, mode, batch_size = 32, epoch = 10):
        ...
        if self.mode == 'train':
            ...
            self.image_path = '/media/tree/backup/projects/new_work/data/train/image256'
            self.point_path = '/media/tree/backup/projects/new_work/data/train/point'
            ...
            self.image_path = '/media/tree/backup/projects/new_work/data/test/image256'
            self.point_path = '/media/tree/backup/projects/new_work/data/test/point'
